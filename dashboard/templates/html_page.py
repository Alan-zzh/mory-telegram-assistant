...
async function loadConfig() {
  try {
    ...
    const categories = {
      ...
      '安全治理': ['ENABLE_MESSAGE_DELETION', 'ORPHAN_CLEANUP_ENABLED', 'KEYWORD_AUTO_DELETE_CONFIG', 'AD_CLEANUP_REACTIONS', 'AD_SELF_UNBAN_ENABLED', 'RETROACTIVE_SCAN_ENABLED', 'EMOJI_MASK_DETECT', 'EDIT_DETECT_ENABLE', 'AD_DETECT_CONFIG', 'ANTIFLOOD_CONFIG', 'ANTI_DELETE_CONFIG', 'SPAM_LIMIT'],
    ...
    const friendlyNames = {
      ...
      'ENABLE_MESSAGE_DELETION': '消息删除', 'ORPHAN_CLEANUP_ENABLED': '孤儿清理', 'AD_CLEANUP_REACTIONS': '广告反应清理', 'AD_SELF_UNBAN_ENABLED': '广告自助复检解封', 'RETROACTIVE_SCAN_ENABLED': '启动追溯',
