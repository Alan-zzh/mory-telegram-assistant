...
## 当前版本
v5.38.56（2026-08-14）· 修复频道评论事件依赖并新增内容相关营销图片卡

生产状态：**仍为 v5.38.55；2026-08-14 19:13–19:20 实测四条自有频道转发均取消置顶，但无频道捕获或评论回执，频道表为空。v5.38.56 已在本地通过目标回归，尚未部署、未做真实频道业务探针**。

## 最近 3 条大事
1. 2026-08-14 v5.38.56：频道群转发直出内容相关彩虹屁、单入口与审核营销图片卡，后到频道事件不重复。
2. 2026-08-14 v5.38.55：私聊按原味/本人/普通索图发送审核照片，福利内容先文字后图片，并取消旧延迟回复。
3. 2026-08-14 v5.38.54：新增七个零 Token 业务问答族，短追问绑定同一主题且修复“怎么约Mory”乱答。
