...
## 当前版本
v5.38.46（2026-08-13）· SM 成人缩写边界与英文姓名误封修复

生产状态：**v5.38.45 正在运行；v5.38.46 已完成本地正反例回归，待生产部署与同入口探针**。

## 最近 3 条大事
1. 2026-08-13 v5.38.46：修复 Smith 等英文姓名被裸 SM 规则误封。
2. 2026-08-13 v5.38.45：裸链接或普通绑定频道不再单独授权广告处置。
3. 2026-08-13 v5.38.44：恢复审计控制面并阻断旧分叉全目录部署。
