...
生产状态：当前生产为 v5.38.3（可信提交 `51bb4c7`，备份 `/home/ubuntu/mory_assistant/backups/deploy_v5383_20260728_200329`）；v5.38.4 明确订阅回复去模板化、近期原句去重及近义表达扩展已通过本地 514 passed / 7 skipped、DB 190/190、文档 7/7，待可信提交和生产回执。
