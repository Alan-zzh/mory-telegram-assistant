...
## 当前版本
v5.42.4（2026-08-31）· 待部署：水果机分销资料广告变体修复

生产状态：**部署前只读基线为 v5.42.3；双服务 active、health 200、数据库完整，v5.42.4 本地门禁通过后再发布并重新取证。**

## 最近 3 条大事
1. 2026-08-31 v5.42.4：水果机分销资料广告组合本地验证通过，待发布。
