...
## 最近 3 条大事
1. 2026-07-25 v5.35.17 生产反例闭环：拒绝短句不再误送预览；模型虚构的价格、画质、独家权益、能力和交付承诺发送前移除。
2. 2026-07-25 v5.35.16 双项目人设与成交链统一：普通聊天不按轮数硬推；了解先预览、明确意向再自助；群承接不再额外轰炸私聊，入口单目标且不虚构服务。
3. 2026-07-25 v5.35.15 定制转化节奏收口：意图继续承接，但近期已给过下单入口时不重复 CTA；私聊零按钮，预览/下单/人工入口单轮互斥。
