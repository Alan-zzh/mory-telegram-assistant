...
## 当前版本
v5.42.13（2026-09-01）· 待部署：修复root看门狗日志的轮转权限

生产状态：**Mory v5.42.12双服务active、NRestarts=0、health 200；启动广告清理二次重启候选0、约2秒完成。v5.42.13尚未部署；午夜logrotate权限失败待修复。MoryFansBot与MediaOps-COO继续在线，同机非保留项目保持停用。**

## 最近 3 条大事
1. 2026-09-01 v5.42.13待部署：修复root看门狗日志轮转权限。
