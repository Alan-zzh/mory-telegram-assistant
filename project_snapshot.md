...
## 当前版本
v5.38.66（2026-08-20）· 同城PC成人交易招揽与显示名漏判修复

生产状态：**v5.38.66 已部署。Bot PID 1613495、Dashboard PID 1613496 均 active/running、NRestarts=0，health 200；截图正文生产评分 4、显示名评分 3，4 条电脑/反诈反例放行。UID 6070826211 保持 kicked，双黑名单和禁言记录均为 1；消息 68564/68608/68650 均已不存在且数据库为 is_ad=1/deleted=1。**

## 最近 3 条大事
1. 2026-08-20 v5.38.66：同城PC交易招揽与同程嫖娼显示名首条处置。
2. 2026-08-19 v5.38.65：入群 Bio 空值有界复审，邀请链接叠加规避引流直接处置。
3. 2026-08-17 v5.38.64：Dashboard 原子保存配置前强制临时文件 0600 权限。
