...
## 当前版本
v5.42.3（2026-08-31）· 已部署：预设白名单与其他机器人事项隔离

生产状态：**v5.42.3 已部署；双服务 active、health 200，远端受影响文件哈希与本地一致，Alembic 到 0011 head；生产回放确认老板预设原文命中，8 条历史外部事项已隔离。**

## 最近 3 条大事
1. 2026-08-31 v5.42.3：预设白名单与外部事项隔离已部署，生产回放通过。
