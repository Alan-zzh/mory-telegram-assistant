...
## 当前版本
v5.42.6（2026-08-31）· 待部署：生产 OOM 来源归因与巡检真实性修复

生产状态：**部署前只读基线为 v5.42.4：双服务 active、NRestarts=0、health 200、数据库完整；2026-08-31 05:31 实读最近一小时 77 次、24 小时 870 次 cgroup OOM，最近一次距取证仅 361 秒，来源全为 `steel-browser`、受害进程全为 Chromium，Mory 来源/受害与未知来源均为 0；load1 已回落至 0.98，但外部 OOM 仍在持续，v5.42.6 发布门禁阻断。**

## 最近 3 条大事
1. 2026-08-31 v5.42.6：OOM 按 Mory、外部容器和未知来源归因，待资源门禁放行。
2. 2026-08-31 v5.42.5：统计、频道和巡检真实性修复已完成，待部署。
3. 2026-08-31 v5.42.4：水果机分销资料广告组合已部署，生产正反例通过。
