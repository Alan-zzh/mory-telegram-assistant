...
## 当前版本
v5.42.15（2026-09-01）· 待部署：清理脚本增加参数先行安全门

生产状态：**当前已验证基线为Mory v5.42.14：双服务active/enabled、NRestarts=0、health 200，数据库与17项生产巡检通过；4条累计失败均正确标记historical，非当前last_error为0。v5.42.15尚未部署；MoryFansBot与MediaOps-COO在线，同机非保留项目保持停用。**

## 最近 3 条大事
1. 2026-09-01 v5.42.15待部署：清理脚本参数错误不再执行写操作。
