...
## 当前版本
v5.38.28（2026-08-06）· 播报视觉修复（深色主题可读性根治：夜色底+深色区块+近白字；背景图去云纹；小字号上提 ≥16px；塔罗牌名半截修复；新增视觉基准文档）

生产状态：**生产仍为 v5.38.27（已验收）**，v5.38.28 待部署。本地验收：pytest 全仓 907 passed/7 skipped、doc_consistency 全项、七张样卡人工复核（晚安/夜间/塔罗/黄历/易经）。

## 最近 3 条大事
1. 2026-08-06 v5.38.28：播报深色主题可读性根治+字号优化；待部署。
