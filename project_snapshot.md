...
生产状态：**部署前只读基线为 v5.42.4：双服务 active、health 200、数据库完整；最新完整审计实读一小时 80 次 cgroup OOM、主机级 OOM 0，来源全为 `steel-browser`、受害进程全为 Chromium，Mory 来源/受害与未知来源均为 0；共享主机 load1 8.51，v5.42.6 继续等待资源门禁恢复。**
