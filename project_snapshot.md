...
## 当前版本
v5.38.43（2026-08-13）· 候选个人频道 unknown 处置门禁

生产状态：**v5.38.42 已部署；200 人 report-only 证实 Profile/评估/真实传输覆盖均 100%，个人频道帖子 0/10 可读；v5.38.43 待门禁与发布**。

## 最近 3 条大事
1. 2026-08-13 v5.38.43：候选当次个人频道帖子 unknown 时禁止处置。
2. 2026-08-13 v5.38.42：Profile 取证与 Bot API 增强不可用/传输异常分层。
3. 2026-08-13 v5.38.41：扫描限速有界并发，资料与个人频道覆盖率独立门禁。
