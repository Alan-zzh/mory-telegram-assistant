...
生产状态：**v5.38.59 已部署。Bot PID 3864929、Dashboard PID 3864931 均 active/running、NRestarts=0，health HTTP 200；关键文件与本地 SHA-256 一致。群聊冷场 5 个主问法、4 个同题追问、5 个无关反例和 FAQ 过滤 5 个用例均通过生产新进程探针；真实 AI 返回 `reply_polished`，Telegram 消息 3514 已送达后删除。**
