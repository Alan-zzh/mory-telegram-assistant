...
生产状态：**v5.38.35 已部署并验收通过**。双服务 active、NRestarts=0、health 200、VPS 版本一致，3 个运行文件 SHA-256 一致；真实用户关联频道命中四锚点，两条残留消息均经 Telegram 复核为 already_absent，永久禁言、双黑名单与 mute_records 持久态均已确认。
