...
生产状态：**Mory v5.42.15双服务active/enabled、NRestarts=0、health 200，数据库与17项生产巡检通过；MoryFansBot与MediaOps-COO在线；同机非保留项目、Docker及相关定时器保持停用，TokenLab遗留的4GiB开机交换文件已移除，根盘占用由60%降至56%。**

## 最近 3 条大事
1. 2026-09-01 清理TokenLab遗留4GiB开机交换文件，三项目复核正常。
2. 2026-09-01 v5.42.15已部署：清理脚本参数错误不再执行写操作。
3. 2026-09-01 v5.42.14已部署：调度当前错误与历史失败分开呈现。
