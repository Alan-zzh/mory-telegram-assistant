...
## 当前版本
v5.38.39（2026-08-13）· 全量成员广告扫描治理

生产状态：**v5.38.38 已部署，v5.38.39 待门禁与发布**。成员扫描生产结果须以本次签名报告、应用回执与 Telegram/数据库读回覆盖更新。

## 最近 3 条大事
1. 2026-08-13 v5.38.39：存量成员扫描与实时广告规则统一，报告和处置分离。
