...
## 当前版本
v5.38.48（2026-08-13）· 普通用户私聊入口恢复自然 AI 首次对话

生产状态：**v5.38.47 正在运行；v5.38.48 已完成本地正反例回归，待生产部署与同入口探针**。

## 最近 3 条大事
1. 2026-08-13 v5.38.48：普通用户 `/start` 恢复自然 AI 私聊，管理入门仅管理员可见。
2. 2026-08-13 v5.38.47：VPN/梯子咨询改为链接推荐并承接短追问。
3. 2026-08-13 v5.38.46：修复 Smith 等英文姓名被裸 SM 规则误封。
