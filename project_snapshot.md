...
生产状态：v5.37.0 已完成三档新闻退役并在生产关闭全部新闻调度；管理员预览 2979–2981 暴露首版文案仍像个人心理教练，因此未投放群聊。v5.37.1 已改为群公共短字段口吻，本地 490 passed / 7 skipped、DB 190/190、文档 7/7，待可信提交后重新部署；生产任务实测为 45 个类/50 个调度项，`news_*=[]`、旧定向 `tarot_*=[]`。
