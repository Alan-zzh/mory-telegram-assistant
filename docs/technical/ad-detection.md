...
### 二点二、处置说明卡与本人复检（v5.38.68）

- `ad_enforcement_events` 保存脱敏规则 ID、类别、字段、强弱、根事件、处置与恢复结果；不保存完整 Bio 或私人消息原文。
- P1 黑名单重申只关联根事件，不覆盖首次原因和时间；同一用户/群/根事件 24 小时只保留一张有效说明卡。
- 卡片提供“已整改，一键复检解封”和联系管理员按钮。只有目标 UID 本人可复检，60 秒限频、最多 5 次、每个事件最多成功恢复一次。
