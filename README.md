...
当前版本 **v5.38.4**：明确问订阅、开通、会员、付费或付款入口时，会结合刚看过预览等近期语境，从多组简短、真人化的 Mory 人设短句中自然承接，并优先避开最近说过的原句；“咋订阅 / 订阅怎么弄 / 会员怎么开 / 开通一下 / 付费入口”及繁体近义问法均可识别。群聊仍只挂一个“🛒 自助下单”按钮，私聊只给正文入口且零按钮；普通聊天、了解阶段和拒绝继续遵守 `none → preview → subscribe` 单目标合同。
