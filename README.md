...
当前版本 **v5.37.1**：早、午、晚三档新闻播报已整体下线，原时段改为群公共口吻的风水、塔罗和晚间宜忌栏目。内容每天变化、同日重试保持一致，只展示宜忌、方位、参考色、牌面和关键词等短信息；不对个人提问、不判断群友情绪、不抓新闻、不带销售入口，旧 15:00 定向塔罗默认关闭。广告检测与 ReplyContract v1 继续保持现有边界。
