...
当前版本 **v5.38.11**：消息层识别 QQ/Q群/扣群/企鹅群/qqun 数字群号；q裙/扣郡等歧义谐音只有同时出现关系招揽、兼职、资源或上门等广告锚点才处置，服装订单、算法讨论和普通关系表达放行。群自动回复六类意图继续统一温情底色并拦截动作旁白与怼人措辞；入群资料审核继续禁止头像颜色、尺寸、比例和文件大小等弱特征单独定罪。
