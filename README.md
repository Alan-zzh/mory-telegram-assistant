...
当前版本 **v5.38.54**：私聊 `/start` 与群首次精确 @ 共用零模型欢迎卡；新增业务预设在 LLM 前零 Token 命中，并按同一会话承接一一对应的短追问。
...
modules 业务 `.py` = 137，core 业务 `.py` = 81，`_job_` = 33，DB 表 = 174，Dashboard 路由 = 163，消息分发函数 = 9，model_router 映射 = 10。
