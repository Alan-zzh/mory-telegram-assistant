...
当前版本 **v5.38.3**：群里明确问“怎么订阅 / 如何订阅 / 订阅入口”等，不再被旧商业搭讪旁路截断或等待模型超时；机器人会结合最近预览语境，用 Mory 小助理清醒、温柔、略带小傲娇的口吻承接，并只挂一个“🛒 自助下单”按钮。私聊仍只给正文可点击入口、零按钮；了解型问题仍只去预览，拒绝不推进。v5.38.2 的六合彩/特码交易黑话首条处置与 v5.38.1 的三档传统文化栏目、私聊零 Token 占卜保持生效。
