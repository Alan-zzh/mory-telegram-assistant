...
当前版本 **v5.38.0**：早、午、晚三档新闻播报保持下线，三个时段固定为不同产品——早间今日黄历读取真实农历、宜忌、冲煞、值日、星宿、方位与节气；午间用三张无重复大阿卡纳组成主牌/助力/提醒牌阵；晚间按六十四卦生成本卦、动爻与真实之卦。Rich/HTML 均使用分区排版；内容跨日变化、同日重试一致。可开启每天轮换的单按钮引导，联系 Mory、预览福利与自助订阅各自只出现一次且与正文一致。旧 15:00 定向塔罗仍默认关闭。
