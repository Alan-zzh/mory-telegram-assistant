...
class MessageTemplates:
    ...
    # 全部文案 30-120 字（对齐 is_usable_greeting 门禁），延续 Mory 清冷+小傲娇+温柔的调性。
    GREETING_FALLBACK_POOL = {
        "morning": [
            "早上好。今天想聊什么，直接在群里说就行。不用特意组织话题，想到哪说到哪。",
            "早安。新一天开始了，大家按自己的节奏来。快一点慢一点都可以，群里始终有人接得住话。",
            "早。大家路过群里就打个招呼，随便聊点什么都行。不急着找话题，冒个泡也是一种参与。",
            "早上好。新朋友和老朋友都可以直接参与群里话题，谁都不必端着。想说什么，说就是了。",
            "早安。昨晚没聊完的话，今天也可以接着聊。群里不赶时间，什么时候想说都可以。",
            "早。今天想分享点什么，或者只想安静围观，都随你。群里聊天没有硬性要求，自在就好。",
            "早上好。早上的人少，想说话正好，不用怕跟不上节奏。回头大家陆陆续续也会来。",
            "早安。用一句简单的问候开场就好，剩下的交给群里自然的节奏。今天也请多指教呀。",
        ],
        "afternoon": [
            "下午好。今天过得怎么样，可以直接在群里聊。顺利也好，卡壳也罢，都有人听。",
            "午安。大家有想分享的，就在群里说两句。不必是大事，小到一杯水也可以聊。",
            "下午了。大家顺利或不顺利，都可以正常聊聊。下午的事不用一次做完，聊聊天缓一缓也行。",
            "午安。大家路过就冒个泡，不用特意组织话题。想安静也行，群里不会因为沉默就冷掉。",
            "下午好。午休醒了想找人说话，群里随时都在。聊几句再回去忙，也算小小换气。",
            "午安。下午的安排如果还没想好，不急着定。先在群里待会儿，随缘聊几句。",
            "下午好。今天有没有什么想吐槽又没说出口的？群里可以说说，说完再继续忙。",
            "午安。下午过半，想休息就休息，想聊就聊。群里不卷，节奏自己定就好。",
        ],
        "evening": [
            "晚上好。今天过得怎么样，可以在群里聊聊。白天没说完的，晚上补上也不迟。",
            "到晚上了。大家白天没空说的话，现在说也不迟。群里这会儿正好有人在线。",
            "晚安前大家路过群里，想分享什么都可以。今天最后一句话，留给你来说。",
            "晚上好。大家今天有没有一件值得记住的小事？有的话说说看，没有的话听别人说也行。",
            "晚上好。白天忙完了，晚上这一会儿是自己的。想安静在群里看看，也完全没问题。",
            "晚安。睡前如果还惦记着什么事，说出来听听。群里不解决难题，但能陪你想想。",
            "晚上好。今晚不急着睡觉的话，可以在群里聊两句再散。明天的事，明天再想也不迟。",
            "晚上了。今天辛苦了，想说话就说话，不想说话就听。群里一直都有位置留给你。",
        ],
        "night": [
            "深夜了。这个点还醒着，大概是心里有事，或者单纯睡不着。群里还亮着灯，想说话就说。",
            "夜深了。白天没消化完的情绪，放在这个点冒出来也正常。愿意说就说，不想说我也不催。",
            "深夜好。睡不着的时候不用硬睡，随便看看群里，说点什么也随你。夜还长，不急。",
            "很晚了。还在线的话，说明今天还没打算就这样结束。群里陪你到想睡为止。",
            "深夜问候。一个人醒着有点安静，群里就不一样了。想聊聊就聊聊，不想就各自安好。",
        ],
    }
