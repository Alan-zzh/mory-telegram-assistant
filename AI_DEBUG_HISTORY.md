...
- 问题 | 调度累计失败、日志 False 和外部 OOM 被误报。根因 | 当前态/历史/来源/受害混用，Steel 1GiB 含 swap 长期打满。解法 | 分离证据口径；Steel 改 1.5GiB 无额外 swap 并按真实 API 7 项验收。预防 | OOM 按来源/受害归因，资源变更保留回滚与业务探针。
