...
_MONITOR_EVIDENCE_KEYS = {
    ...
    "l5_scheduler": {"transactional_task_status_1h", "transactional_failed_1h", "task_history_coverage", "task_status_1h", "failed_1h", "running_1h", "aborted_1h", "stale_running_30m", "recent_persisted_failures", "scheduler_metrics_errors", "scheduler_metrics_cumulative_failures", "scheduler_metrics_failure_history", "recent_scheduled_tasks", "fail_log_10min_count", "watchdog_usec", "_warn", "_crit", "_exc"},
