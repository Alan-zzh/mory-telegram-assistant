...
_STRONG_SUBSCRIBE_READY_MARKERS = (
    "怎么下单", "如何下单", "在哪下单", "我要下单", "想下单", "直接下单", "下单吧",
    "下单入口", "下单链接", "自助下单", "自助机器人", "下单机器人", "订单机器人",
    "怎么订阅", "如何订阅", "在哪订阅", "咋订阅", "我要订阅", "想订阅", "要订阅",
    "订阅怎么弄", "订阅咋弄", "订阅怎么办", "订阅入口", "订阅链接", "订阅一下", "订阅吧",
...
_GENERIC_PURCHASE_ACTION_MARKERS = (
    "怎么买", "我要买", "想买", "要买", "直接买", "买这个",
    "怎么购买", "如何购买", "我要购买", "想购买", "要购买",
    "怎么付费", "如何付费", "在哪付费", "我要付费", "想付费",
    "付费入口", "付费入口在哪", "付费链接", "付费链接发我",
    "怎么付款", "如何付款", "在哪付款", "我要付款",
    "付款入口", "付款入口在哪", "付款链接", "付款链接发我",
    "怎麼買", "我要買", "想買", "怎麼購買", "如何購買", "我要購買",
    "就要这个", "选这个",
)
