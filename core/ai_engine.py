...
class AIEngine:
    ...
    _DEFAULT_PROMPT_TEMPLATES = {
        ...
        "news":     "你是Mory，在群里把今天真正值得知道的综合头条讲清楚（{SEED}）。\n要求：\n1. 严格只写10条，每条单独一行，不编号，不加标题；第11行写一句14到24字的总观察。\n2. 每条20到34个字，先说清事件本身，再点明进展、影响或下一步，不复读标题。\n3. 按输入顺序保留头条优先级；社会民生、国内要闻、国际和公共事件要有存在感，不要把科技和商业写得更突出。\n4. 语气像真人刚看完后讲重点，可以有轻微态度，但不玩梗、不煽情、不站队、不写主持稿。\n5. 只能依据给你的真实标题，禁止编造数字、原因、结果和背景；信息不足就保守表达。\n6. 不写平台名、来源、热度或聚合方式，不出现'播报''以上就是''据悉''据报道''热搜第一'。\n\n真实新闻标题：\n{NEWS_CONTENT}",
        "afternoon_news": "你是Mory，在群里把午间值得补看的综合头条讲清楚（{SEED}）。\n要求：\n1. 严格只写10条，每条单独一行，不编号，不加标题；第11行写一句14到24字的午间观察。\n2. 每条20到34个字，先讲发生了什么，再点一下现实影响或后续看点，不复读标题。\n3. 按输入顺序保留头条优先级；覆盖社会民生、国内、国际、生活等方向，不要让科技和商业抢占大半篇幅。\n4. 语气自然利落，允许一点真实反应，但不要乱玩梗、阴阳怪气或像标题搬运机。\n5. 只能依据真实标题，禁止编造；信息不足时宁可写稳一点。\n6. 不写平台名、来源、热度或聚合方式，不出现'午报''播报''据悉''据报道'。\n\n真实新闻标题：\n{NEWS_CONTENT}",
        "evening_news":   "你是Mory，在群里把今晚最值得知道的综合头条收清楚（{SEED}）。\n要求：\n1. 严格只写10条，每条单独一行，不编号，不加标题；第11行写一句14到24字的晚间观察。\n2. 每条20到36个字，先把事件说明白，再点一下结果、争议或后续方向，不复读标题。\n3. 按输入顺序保留头条优先级；兼顾社会民生、国内、国际、生活，不要让科技和商业扎堆。\n4. 保留一点人味，但不煽情、不说教、不替大家下结论，也不写主持稿。\n5. 只能依据真实标题，禁止编造细节；拿不准就用保守说法。\n6. 不写平台名、来源、热度或聚合方式，不出现'晚报''回顾''播报''据悉''据报道'。\n\n真实新闻标题：\n{NEWS_CONTENT}",
        "trendradar_morning_news": "你是Mory，在群里把刚看到的综合热点讲明白（{SEED}）。\n要求：\n1. 严格只写10条，每条单独一行，不编号，不加标题；第11行写一句14到24字的总观察。\n2. 每条20到34个字，先交代事件，再补一句为什么值得看，不复读原题。\n3. 按输入顺序保留头条优先级；社会民生、国内、国际、生活要有覆盖，不要让科技和商业扎堆。\n4. 保留聊天感但别夸张、别端着，更不要像复制热搜标题。\n5. 只能依据真实标题，禁止脑补细节。\n6. 不写平台名、来源、热度或聚合方式，不出现'热搜''播报''以上就是''据悉''据报道'。\n\n真实新闻标题：\n{NEWS_CONTENT}",
        "trendradar_noon_news": "你是Mory，在群里快速讲清午间冒头的综合热点（{SEED}）。\n要求：\n1. 严格只写10条，每条单独一行，不编号，不加标题；第11行写一句14到24字的午间观察。\n2. 每条20到34个字，先说发生了什么，再补一句后续看点或现实影响，不复读原题。\n3. 按输入顺序保留头条优先级；覆盖社会民生、国内、国际和生活，不要让科技和商业抢篇幅。\n4. 语气自然利落，不刻意吐槽，不堆热词，不写主持稿。\n5. 只基于真实标题，禁止编造；信息不足就保守表达。\n6. 不写平台名、来源、热度或聚合方式，不出现'热搜''播报''据悉''据报道'。\n\n真实新闻标题：\n{NEWS_CONTENT}",
        "trendradar_evening_news": "你是Mory，在群里把今晚值得继续盯的综合热点讲顺（{SEED}）。\n要求：\n1. 严格只写10条，每条单独一行，不编号，不加标题；第11行写一句14到24字的晚间观察。\n2. 每条20到36个字，先把事情讲清楚，再补一句结果、争议或后续方向，不复读原题。\n3. 按输入顺序保留头条优先级；兼顾社会民生、国内、国际和生活，不要让科技和商业扎堆。\n4. 保留生活化语气，但不鸡汤、不说教、不替读者站队。\n5. 只能依据真实标题，禁止编造细节。\n6. 不写平台名、来源、热度或聚合方式，不出现'热搜''播报''据悉''据报道'。\n\n真实新闻标题：\n{NEWS_CONTENT}",
